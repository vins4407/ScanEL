...
const FullScan = () => {
    ...
    const generatePDF = () => {
        ...
        html2pdf()
            .set({ margin: 10, filename: 'report.pdf', image: { type: 'jpeg', quality: 0.98 } })
            .from(element)
            .save();
    };
        ...
        data: {
            ...
            <div className='toolData'>
                ...
                <div className='infoTab'>
                    ...
                    <li>
                        <a href="https://www.acunetix.com/websitesecurity/directory-traversal/" target="_blank">Acunetix: What is a Directory Traversal attack?</a>
                    </li>
                    <li>
                        <a href="https://cwe.mitre.org/data/definitions/22.html" target="_blank">CWE-22: Improper Limitation of a Pathname to a Restricted Directory ('Path Traversal')</a>
                    </li>
                    </ul>
                </div>
          </div>
